...
var _reactDom = __webpack_require__(7);var _reactDom2 = _interopRequireDefault(_reactDom);
var _Header = __webpack_require__(25);var _Header2 = _interopRequireDefault(_Header);
var _Footer = __webpack_require__(26);var _Footer2 = _interopRequireDefault(_Footer);
var _ToDoList = __webpack_require__(27);var _ToDoList2 = _interopRequireDefault(_ToDoList);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}


_reactDom2.default.render(_react2.default.createElement(_Header2.default, null), document.getElementById('header')); /* 
                                                                                                                         ./client/index.js
                                                                                                                     */_reactDom2.default.render(_react2.default.createElement(_ToDoList2.default, null), document.getElementById('root'));_reactDom2.default.render(_react2.default.createElement(_Footer2.default, null), document.getElementById('footer'));
...
*/
var ba=__webpack_require__(2),ea=__webpack_require__(0),m=__webpack_require__(9),A=__webpack_require__(4),C=__webpack_require__(3),fa=__webpack_require__(10),ha=__webpack_require__(11),ja=__webpack_require__(12),ka=__webpack_require__(5);
...
var _reactDom = __webpack_require__(7);var _reactDom2 = _interopRequireDefault(_reactDom);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self, call) {if (!self) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call && (typeof call === "object" || typeof call === "function") ? call : self;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;}var

Header = function (_React$Component) {_inherits(Header, _React$Component);function Header() {_classCallCheck(this, Header);return _possibleConstructorReturn(this, (Header.__proto__ || Object.getPrototypeOf(Header)).apply(this, arguments));}_createClass(Header, [{ key: 'render', value: function render()
        {
            return (
                _react2.default.createElement('div', { className: 'page-header' },
                    _react2.default.createElement('h1', null, '1.[REACT] Pet Project - To Do List')));


        } }]);return Header;}(_react2.default.Component);exports.default =
...
Footer = function (_React$Component) {_inherits(Footer, _React$Component);function Footer() {_classCallCheck(this, Footer);return _possibleConstructorReturn(this, (Footer.__proto__ || Object.getPrototypeOf(Footer)).apply(this, arguments));}_createClass(Footer, [{ key: 'render', value: function render()
        {
            return (
                _react2.default.createElement('div', null,
                    ...
                    _react2.default.createElement('p', null, 'Todolist -(30/10/2017) - Phong Bui')));
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();var _react = __webpack_require__(0);var _react2 = _interopRequireDefault(_react);
var _InputTDL = __webpack_require__(28);var _InputTDL2 = _interopRequireDefault(_InputTDL);
var _ToDoListIterm = __webpack_require__(29);var _ToDoListIterm2 = _interopRequireDefault(_ToDoListIterm);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self, call) {if (!self) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call && (typeof call === "object" || typeof call === "function") ? call : self;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;}

var todos = [
{ name: 'Brush your teeth', isComplete: 0 },
{ name: 'Eat your breakfast', isComplete: 1 }];var



ToDoList = function (_React$Component) {_inherits(ToDoList, _React$Component);
    function ToDoList(props) {_classCallCheck(this, ToDoList);var _this = _possibleConstructorReturn(this, (ToDoList.__proto__ || Object.getPrototypeOf(ToDoList)).call(this,
        props));Object.defineProperty(_this, 'isExist', { enumerable: true, writable: true, value:
            ...
            function value(newTask) {
                var exist = _this.state.todos.find(function (task) {
                    return task.name.trim().split(" ").join("") == newTask.trim().split(" ").join("");
                });
                return exist ? true : false;
            } });Object.defineProperty(_this, 'addNewTask', { enumerable: true, writable: true, value:
            function value(task) {
                var data = _this.state.todos;
                data.push(task);
                _this.refreshData(data, true);

            } });Object.defineProperty(_this, 'removeNewTask', { enumerable: true, writable: true, value:
            function value(index) {
                var data = _this.state.todos;
                data.splice(index, 1);
                _this.refreshData(data, false);
                console.log(index);
                return;
            } });Object.defineProperty(_this, 'DoneTask', { enumerable: true, writable: true, value:
            function value(index) {
                var data = _this.state.todos;
                ...
                _this.refreshData(data, true);
                return;
            } });_this.state = { todos: todos };return _this;}_createClass(ToDoList, [{ key: 'refreshData', value: function refreshData(data, isSort) {if (isSort) {data.sort(function (a, b) {return a.isComplete - b.isComplete;});}this.setState(data);} }, { key: 'render', value: function render()
        {
            return (
                _react2.default.createElement('div', null,
        ...
        } }]);return ToDoList;}(_react2.default.Component);exports.default =
...
InputTDL = function (_React$Component) {_inherits(InputTDL, _React$Component);
    function InputTDL(props) {_classCallCheck(this, InputTDL);var _this = _possibleConstructorReturn(this, (InputTDL.__proto__ || Object.getPrototypeOf(InputTDL)).call(this,
        props));Object.defineProperty(_this, 'onCreated', { enumerable: true, writable: true, value:
            ...
            function value() {
                var createFunc = _this.props.addNewTask;
                var data = {
                    name: _this.refs.NewTask.value,
                    isComplete: 0 };

                var invalid = _this.props.isExist(data.name);
                if (!invalid) {
                    createFunc(data);
                    _this.setState({ showError: 0 });
                } else {
                    _this.setState({ showError: 1 });
                }
                return;
            } });_this.state = { showError: 0 };return _this;}_createClass(InputTDL, [{ key: 'showError', value: function showError() {if (this.state.showError == 1) {return _react2.default.createElement('p', { style: this.getStyleError() }, 'Task is exist');}} }, { key: 'getStyleError', value: function getStyleError()
        {
            return {
            ...
            return (
                _react2.default.createElement('div', { className: 'form-group' },
                    _react2.default.createElement('div', { className: 'col-md-4' },
                        _react2.default.createElement('div', { className: 'col-md-3', style: { top: "5px" } },
                            _react2.default.createElement('label', { htmlFor: 'usr' }, 'Task:')),

                        _react2.default.createElement('div', { className: 'col-md-7' },
                            _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'usr', ref: 'NewTask', placeholder: 'input your task' }))),



                    _react2.default.createElement('button', { className: 'btn btn-warning', onClick: this.onCreated }, 'Add'),
                    this.showError()));


        } }]);return InputTDL;}(_react2.default.Component);exports.default =
...
ToDoListItem = function (_React$Component) {_inherits(ToDoListItem, _React$Component);
    function ToDoListItem(props) {_classCallCheck(this, ToDoListItem);return _possibleConstructorReturn(this, (ToDoListItem.__proto__ || Object.getPrototypeOf(ToDoListItem)).call(this,
        props));
    }_createClass(ToDoListItem, [{ key: 'getStyleTaskStatus', value: function getStyleTaskStatus(

        isCompleted) {
            return isCompleted ? { color: 'red', textDecoration: 'line-through' } : { color: 'green' };
        } }, { key: 'buildTodoItem', value: function buildTodoItem()
        {
            var sefl = this;
            var list = this.props.todos || [];
            return list.map(function (task, key) {
                var onClickDoneTaskFunc = sefl.DoneTask.bind(sefl, key, 'hello');
                var onClickRemoveFunc = sefl.removeNewTask.bind(sefl, key);
                return (
                    _react2.default.createElement('li', { key: key, style: sefl.getStyleTaskStatus(task.isComplete) },
                        _react2.default.createElement('span', { key: key, className: 'btn', onClick: onClickRemoveFunc }, 'X'),
                        _react2.default.createElement('span', { onClick: onClickDoneTaskFunc }, task.name)));


            });
        } }, { key: 'DoneTask', value: function DoneTask(
        index, sayHello, e) {
            console.log(sayHello);
            var DoneTaskFunc = this.props.DoneTask;
            DoneTaskFunc(index);
        } }, { key: 'removeNewTask', value: function removeNewTask(
        index, e) {
            var removeNewTaskFunc = this.props.removeNewTask;
        ...
        } }]);return ToDoListItem;}(_react2.default.Component);exports.default =
